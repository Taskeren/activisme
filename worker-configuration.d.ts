/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: ad50590faf62f7e2f9aa0f75667be400)
// Runtime types generated with workerd@1.20260701.1 2026-07-04 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BNET_TOKEN: KVNamespace;
	ASSETS: Fetcher;
	BNET_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BNET_API_KEY" | "BNET_CLIENT_ID" | "BNET_CLIENT_SECRET">> {}
}
